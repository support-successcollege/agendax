          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
              <section>
                ...
                <p>
                  ברוכים הבאים ל-Agendax. השימוש באתר זה מהווה הסכמה לתנאי השימוש המפורטים להלן. 
              ...
              <section>
                ...
                <p>
                  ...
                  או לעשות שימוש מסחרי בתכנים אלו ללא אישור מפורש בכתב מ-Agendax.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Agendax שואף לספק מידע מדויק ועדכני. עם זאת, איננו מתחייבים לדיוק מוחלט 
              ...
              <section>
                ...
                <p>
                  האתר עשוי להכיל קישורים לאתרים של צדדים שלישיים. Agendax אינו אחראי לתוכן, 
              ...
              <section>
                ...
                <p>
                  Agendax לא יישא באחריות לכל נזק ישיר, עקיף, מקרי או תוצאתי הנובע משימוש 
