          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
              ...
              <section>
                ...
                <p>
                  אנחנו מאמינים בעיתונות איכותית, מדויקת ואמינה. המטרה שלנו היא לספק לקוראים שלנו 
                  מידע מעמיק ומקצועי שיעזור להם להבין את העולם סביבם ולקבל החלטות מושכלות.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li><strong>מקצועיות:</strong> הצוות שלנו מורכב מעיתונאים ומומחים בתחומים השונים</li>
