  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="container py-8" id="main-content">
      <article className="mx-auto max-w-[72ch]">
        ...
        <Section title="הפיקוח האנושי">
          <p>
            לפני פרסום כל כתבה עוברת שני שלבים: בדיקת עריכה אוטומטית שמחפשת אי-דיוקים,
            כותרות מטעות וחוסר במקורות, ואישור של עורך אנושי מהצוות. עורך יכול לתקן,
            לעכב או לפסול כל כתבה. אף כתבה לא עולה לאוויר בלי שאדם ראה אותה.
          </p>
        </Section>
