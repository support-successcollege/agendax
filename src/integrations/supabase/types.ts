...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      articles_backup_20260830_prerun: {
        Row: {
          author: string | null
          category: string | null
          category_slug: string | null
