...
serve(async (req) => {
  ...
  try {
    ...
    const dataPrompt = `
אתה יועץ אסטרטגי לאתר חדשות בשם Agendax. נתח את הנתונים הבאים ותן המלצות מעשיות ומפורטות.
...
6. תן לפחות 5 המלצות מפורטות`;
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "אתה יועץ אסטרטגי מומחה לאתרי חדשות דיגיטליים. אתה מנתח נתונים ונותן המלצות מעשיות, ספציפיות ומבוססות נתונים. כתוב תמיד בעברית." },
